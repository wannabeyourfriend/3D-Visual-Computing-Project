...
parser.add_argument('--dataset_path', type=str, default='/cluster/home1/wzx/diffusion-point-cloud/data/shapenet_core_2048.h5')
parser.add_argument('--categories', type=str_list, default=['airplane', 'bag', 'car', 'table'])
